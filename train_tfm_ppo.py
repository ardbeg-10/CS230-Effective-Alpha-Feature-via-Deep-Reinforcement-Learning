...
def main(
    ...
    POOL_PATH = 'pretrained/pretrained_pool.json'
    MASK_PATH = 'pretrained/pretrained_mask.zip'
    custom_exprs, _ = load_alpha_pool_by_path(POOL_PATH)
    ...
    #model = MaskablePPO.load(MASK_PATH, env=env)
